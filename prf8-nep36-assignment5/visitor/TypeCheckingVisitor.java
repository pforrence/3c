...
public class TypeCheckingVisitor implements TypeVisitor
{
    ...
    public Type visit(If n)
    {
        ...
        {
            System.out.println("Non-boolean expression used as the condition of if statement at line " + 10 + ", character " + 10);
            errorDetected = true;
        }
    ...
    public Type visit(While n)
    {
        ...
        {
            errorDetected=true;
            System.out.println("Non-boolean expression used as the condition of while statement at line " + 10 + ", character " + 10);
        }
    ...
    public Type visit(Assign n)
    {
        ...
        if(n.i.s.equals("this"))
        {
            internalError = true;
            errorDetected=true;
            System.out.println("Invalid l-value: "+n.i.s+" is a this, at line "+ 10 +", character "+ 10);
        }
        else if(symTable.isClass(n.i.s))
        {
            internalError = true;
            errorDetected=true;
            System.out.println("Invalid l-value: "+n.i.s+" is a class, at line "+ 10 +", character "+ 10);
        }
        else
        {
            if(currClass.isMethod(n.i.s))
            {
                internalError = true;
                errorDetected=true;
                System.out.println("Invalid l-value: "+n.i.s+" is a method, at line "+ 10+", character "+ 10);
            }
        }
        ...
        if(t instanceof IdentifierType)
        {
            ...
            if(currClass.isMethod(id.s))
            {
                internalError = true;
                errorDetected = true;
                System.out.println("Invalid r-value: " + id.s + " is a method, at line " + 10 + ", character " + 10);
            }
            //}
        }
        ...
        {
            errorDetected = true;
            System.out.println("Type mismatch during assignment at line " + 10 + ", character " + 10);
        }
    ...
    public Type visit(ArrayAssign n)
    {
        ...
        if(t instanceof IdentifierType)
        {
            ...
            if(symTable.isClass(id.s))
            {
                internalError = true;
                errorDetected = true;
                System.out.println("Invalid r-value: " + id.s + " is a class, at line " + 10 + ", character " + 10);
            }
            else
            {
                if(currClass.isMethod(id.s))
    ...
    public Type visit(And n)
    {
        ...
        {
            errorDetected = true;
            System.out.println("Attempt to use boolean operator && on non-boolean operands at line " + 10 + ", character " + 10);
        }
    ...
    public Type visit(LessThan n)
    {
        ...
        if(t1 instanceof IdentifierType)
        {
            ...
            if(symTable.isClass(id.s) || currClass.isMethod(id.s))
            {
                ...
                errorDetected = true;
                System.out.println("Invalid operands for < operator, at line "+10+", character"+10);
            }
        }
        ...
        if(!invalidOperands)
        {
            ...
            {
                errorDetected = true;
                System.out.println("Non-integer operand for operator <, at line " + 10 + ", character " + 10);
            }
        }
        return new BooleanType();
    }
    ...
    public Type visit(ArrayLength n)
    {
        ...
        {
            errorDetected = true;
            System.out.println("Length property only applies to arrays line " + 10 + ", character " + 10);
        }
    ...
    public Type visit(Call n)
    {
        ...
        {
            errorDetected = true;
            System.out.println("Attempt to call a non-method at line"+10+", character "+10);
        ...
        if(!(cst.getMethod(methName).numParameters() == (n.el.size()+1)))
        {
            numParamError = true;
            errorDetected = true;
            System.out.println("Call of method " + methName + " does not match its declared number of arguments at line " + 10 + ", character " + 10);
        }
        ...
        for ( int i = 0; i < n.el.size(); i++ )
        {
            ...
            if(!numParamError)
            {
                ...
                if(!compareTypes(t, strToType(v.getType())))
                {
                    ...
                    errorDetected = true;
                    System.out.println("Call of method " + methName + " does not match its declared signature at line " + 10 + ", character " + 10);
                    break;
                }
            }
        }
    ...
    public Type visit(This n)
    {
        ...
        {
            errorDetected = true;
            System.out.println("Illegal use of keyword 'this' in static method at line " + 10 + ", character " + 10);
            return new VoidType();
        }
        else
        {
    ...
    public Type visit(Not n)
    {
        ...
        {
            errorDetected = true;
            System.out.println("Attempt to use boolean operator ! on non-boolean operand at line " + 10 + ", character " + 10);
        }
